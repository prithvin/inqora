	...
	$.alerts = {
		...
		_show: function(msg, value, ok, cancel, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'prompt':
					$("#popup_message").append('<br /><input style="padding:3px;" type="text" size="30" id="popup_prompt" />').after('<br /><div id="popup_panel"><input type="button" style="cursor:pointer;" value="' + ok + '" id="popup_ok" /> &nbsp; &nbsp; <input type="button" style="cursor:pointer;" value="' + cancel + '" id="popup_cancel" /></div><br />');
